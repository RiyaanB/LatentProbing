...
from generative_models.common import normalize_imagenet
...
class ConvEncoder(nn.Module):
    ...
    def __init__(self, in_channels=3, c_dim=128):
        super().__init__()
        self.conv0 = nn.Conv2d(in_channels, 32, 3, stride=2)
...
class Resnet18(nn.Module):
    ...
    def __init__(self, in_channels, c_dim, normalize=True, use_linear=True):
        super().__init__()
        self.normalize = normalize
        self.use_linear = use_linear
        self.features = models.resnet18(pretrained=True)
        self.in_channels = in_channels
        self.features.conv1 = nn.Conv2d(in_channels, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)
